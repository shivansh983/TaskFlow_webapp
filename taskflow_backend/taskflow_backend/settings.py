...
SECRET_KEY = 'django-insecure-dv3ce4s2#(fxfu=tk7yt7$pc5q7yo^ryvvw@_zqx&u9q3%trpn'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'user': '500/minute',  # Increased for development
        'anon': '50/minute',   # Increased for development
    },
}
